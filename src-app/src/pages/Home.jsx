            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: 40 }}>
              <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 28, padding: "32px 36px", borderRadius: 20, background: "#ffffff", border: "1px solid #e6e8ea", width: "100%", maxWidth: 640 }}>
                ...
                <div style={{ flex: "1 1 260px", minWidth: 0 }}>
                  ...
                  <p style={{ margin: "10px 0 0", fontSize: 16, lineHeight: "24px", color: "#534434" }}>Helping industries and people connect with technical solutions, Omkar handles Tritorc's global marketing. He's also the founder of Project ALFA, a tech non-profit.</p>
                </div>
              </div>
            </div>
          </div>
